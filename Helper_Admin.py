...
# -------------------------------------------------------------------
# BLOCO PRINCIPAL DA PÁGINA ADMIN
# -------------------------------------------------------------------

def main():
    st.title("Painel Administrativo EVA / EMA")

    # ----------------------------------------------------------------
    # Sidebar com datas (como no Admin original)
    # ----------------------------------------------------------------
    with st.sidebar:
